...
Examples:
  pixi run -e docling python agent/docling_dots_mocr_ref.py agent/demo.pdf -o md/demo.dots.mocr.md
  pixi run -e docling python agent/docling_dots_mocr_ref.py pdf/paper.pdf -o md/paper.dots.mocr.md --svg-dir svg/paper.dots.mocr
  pixi run -e docling python agent/docling_dots_mocr_ref.py debug_agent/paper.subset.pdf --concurrency 8 --svg-model rednote-hilab/dots.mocr-svg
