...
Examples:
  pixi run -e docling python agent/docling_ref.py agent/demo.pdf -o md/demo.docling.md
  pixi run -e docling python agent/docling_ref.py agent/demo.pdf -o md/demo.docling.md --concurrency 10
  pixi run -e docling python agent/docling_ref.py --list-presets

Notes:
  Run this script from the dedicated pixi `docling` environment.
