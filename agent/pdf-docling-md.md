...
- run `agent/docling_ref.py` in the dedicated `docling` environment for `pdf -> markdown`

```bash
pixi run -e docling python agent/docling_ref.py agent/demo.pdf -o md/demo.md
```
