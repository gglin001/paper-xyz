...
- `txt/` and `_demos/`(optional): auxiliary artifacts.
- `pixi.toml` and `pixi.lock`: environment and dependency definitions.

Keep filename stems aligned across formats, e.g. `pdf/MyPaper.pdf` -> `md/MyPaper.md`.
